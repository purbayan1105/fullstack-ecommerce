...
const Footer = () => {
  return (
    <>
      <div className="grid lg:grid-cols-6 bg-slate-800 text-white justify-center items-center lg:h-[10dvh] relative">
        <div className="flex justify-center gap-3 col-span-2 items-center">
          <FaReact size={25} />
